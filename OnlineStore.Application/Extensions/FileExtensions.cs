...
using OnlineStore.Application.Convertors;
using System;
...
namespace OnlineStore.Application.Extensions
{
    public static class FileExtensions
    {
            ...
            int? height = default, string thumbPath = null, string deletefileName = null, bool checkImageContent = true)
        {
            ...
            if ((!string.IsNullOrEmpty(deletefileName)) && deletefileName != "NoPhoto.png")
            {
        ...
        {
            if ((string.IsNullOrEmpty(imageName)) || imageName == "NoPhoto.png") return;
            originalPath = Directory.GetCurrentDirectory() + "/wwwroot" + originalPath;
